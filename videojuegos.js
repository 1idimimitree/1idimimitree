...
let todosLosJuegos = [];  // aqui vamos a guardar los datos, vacio por ahora
...
buscador.addEventListener('input', () => {
  ...
  const filtrados = todosLosJuegos.filter(item =>
...
fetch("coleccion.json")
  ...
  .then(datos => {
    todosLosJuegos = datos.filter(item => item.tipo === "Juego");
    pintarJuegos(todosLosJuegos)
  });